...
- [todo] do not introduce backward-compatible serialization discriminator, after refactor clipboard will be deleted
...
## Strwam G - Color copy fix
- [todo] colrors like rgb(124, 243, 121), hsl(119, 84%, 71%) were detected as color, but the card showed color gradient of application, anto not filled by the copied color
